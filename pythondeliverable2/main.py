...
while True:
    ...
    cont_selection = print("Would you like to buy another piece of fruit? y/n")
    cont_selection = input(">")
    while cont_selection.lower() not in ["y", "n"]:
        print("Please enter a valid response")
        cont_selection = print("Would you like to buy another piece of fruit? (y/n) ")
        cont_selection = input(">")
...
before_tax = "Sub Total: ${:.2f}"
print(before_tax.format(sub_total))
tax = sub_total * .05
final_tax = "5% Tax: ${:.2f}"
